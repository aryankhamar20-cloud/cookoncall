  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 bg-[var(--red-err)] text-white text-[0.6rem] font-bold min-w-[16px] h-4 rounded-full flex items-center justify-center">
